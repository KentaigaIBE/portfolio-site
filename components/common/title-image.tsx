...
export default function TitleImage(props: any) {
  ...
  const textClass = `${props.textSize} + ${props.textColor} + w-full text-center transition-all duration-1000 font-black absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 uppercase drop-shadow-lg z-20`;

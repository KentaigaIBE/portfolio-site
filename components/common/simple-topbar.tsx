...
export default function SimpleTopbar(props: any) {
  return (
    <div className="fixed flex h-12 w-screen bg-white drop-shadow-lg z-40 justify-between">
      <Link href={"/"}>
        <button className="flex justify-center items-center bg-orange-400 w-12 h-12 z-50 drop-shadow-lg hover:bg-white w-12 h-12 z-50 drop-shadow-lg transition-colors duration-1000 group">

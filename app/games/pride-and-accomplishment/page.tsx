  ...
  return (
    <main className="flex min-h-screen flex-col items-center pw-24 overflow-x-clip">
      ...
      <div className="text-black dark:text-white my-8 mx-4 w-screen p-4">
        ...
        <LazyMux
          className="relative md:left-1/4 md:w-1/2 my-8"
          title="Pride and Accomplishment Demo"
          metadataVideoId="pride-and-accomplishment-demo"
          metadataVideoTitle="Pride and Accomplishment Demo"
          streamType="on-demand"
          playbackId="fu3yvrO3KFESt7HQwMlmJsNgbEBeQmEUnOcEGavvlzE"
          aspectRatio={16 / 9}
          thumbnailTime={0}
          placeholder={
            (
              await muxBlurHash("fu3yvrO3KFESt7HQwMlmJsNgbEBeQmEUnOcEGavvlzE", {
                time: 0,
              })
            ).blurHashBase64
          }

    ...
    <main className="flex min-h-screen flex-col items-center">
      ...
      <div className="text-black dark:text-white my-8 mx-4 w-2/3 self-center">
        ...
        <p>
          ...
          what you're paying for each month, but it also allows you to cancel
          these subscriptions from the app itself. In situations where that's
          not possible, links to the relevant pages of the service are provided
          to make the process as easy as possible. This section also provides
          its own rewards for paying down bills and debt, encouraging good
          financial habits.
        </p>
        <br></br>
        <p>
        ...
        <p>
          Now it's one thing to have these principles, but it's another to
          actually implement them, so let's get into how I turned each other
          these into tangible design choices in the app.
        </p>
        <br></br>
        <p>
        ...
        <p>
          ...
          that what they've done is what they want. If you don't communicate
          back to them about what they're doing, they may make a mistake, and in
          an app that deals with finances it's especially important to avoid
          that. To facilitate this, all actions are performed as soon as the
          user requests them, with visibile feedback to communicate to the user
          that what they want is being done. When someone hits the "cancel
          subscription" button, that is exactly what happens. Something simple
          like a checkmark popping up is enough to communciate to our user that
          what they wanted was achieved, which is a must when it comes to
          something like cancelling a bill or making an investment. If for some
          reason that action can't be performed, the user is informed why and
        ...
        <p>
          ...
          for Android, Google's Material Design 3 was the baseline, following
          its rigid standards for text, elevation, iconography, and color.
          Embracing these design systems ensure the absolute highest amount of
          consistency, making the app just as natural feeling to use as the OS
          it is installed on. Additionally, the design throughout all screens
          and components is similar, meaning that once you understand how one
          section of Aureus functions, the rest will be very easy to pick up.
        </p>
        <div className="flex flex-col md:flex-row justify-evenly items-center gap-4">
          <InteractiveImage
